...
>(({ className, ...props }, ref) => (
  <CheckboxPrimitive.Root
    ref={ref}
    className={cn(
      // Base box: visible border + white bg when unchecked
      ...
      // Checked state: solid blue bg + matching border
  ...
  >
    <CheckboxPrimitive.Indicator
      // flex + explicit white text is what actually makes the tick visible —
      // without this the Check icon inherits text-current and can end up
      // blue-on-blue (invisible) depending on the parent's text color.
