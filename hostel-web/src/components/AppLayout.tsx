...
//   ScrollText, Search, Ticket, Wrench, Receipt
// } from "lucide-react";
...
//                   className={cn(
//                     "w-full group flex items-center gap-3 px-3 py-2 rounded-lg text-[13px] font-medium transition-all duration-150 text-left",
//                     hasActiveChild
...
//             <button
//               className="md:hidden text-slate-500 hover:text-slate-800 transition-colors shrink-0"
...
//                 className="flex items-center gap-2.5 pl-2 pr-1 py-1 rounded-full hover:bg-slate-100 transition-colors"
//               >
