...
export default function HomePage() {
  ...
  // Scrolls to an in-page section without ever writing a "#id" into the
  // address bar. Plain <a href="#properties"> anchors update
  // location.hash as a side effect of navigation, which is why the URL
  // bar was showing localhost:5173/#contact etc. Intercepting the click
  // and scrolling manually avoids touching the hash entirely.
      ...
      <header className="sticky top-0 z-40 bg-white/80 backdrop-blur-xl border-b border-slate-200/80 shadow-xs">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8 text-xs font-bold uppercase tracking-wider text-slate-600">
            <a href="#properties" onClick={(e) => handleNavClick(e, "properties")} className="hover:text-indigo-600 transition-colors">
              Properties
            </a>
            <a href="#about" onClick={(e) => handleNavClick(e, "about")} className="hover:text-indigo-600 transition-colors">
              Experience
            </a>
            <a href="#contact" onClick={(e) => handleNavClick(e, "contact")} className="hover:text-indigo-600 transition-colors">
              Support
            </a>
          </nav>
      ...
      <section className="relative bg-gradient-to-b from-slate-900 via-indigo-950 to-slate-900 text-white py-28 px-6 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 text-xs font-bold tracking-widest uppercase text-indigo-300 bg-indigo-500/10 border border-indigo-500/20 rounded-full mb-6 backdrop-blur-md">
            ...
            Now Accepting Bookings for {new Date().getFullYear()}
          </div>

          <h1 className="text-4xl sm:text-6xl font-black tracking-tight mb-6 leading-[1.15]">
            Welcome to Brindhavanam <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-sky-400">Managed Residences</span>
          </h1>

          <p className="text-sm sm:text-base text-slate-300 font-normal max-w-2xl mx-auto leading-relaxed mb-10">
            Redefining modern living for students & professionals. Experience premium co-living spaces complete with high-speed connectivity, 24/7 security, gourmet dining, and vibrant community areas.
          </p>
