...
//                           </div>
//                           <span className="text-[13px] font-bold text-gray-900">{row.description || '-'}</span>
//                         </div>
//                       </td>
//                       <td>
...
//                       </td>
//                       <td>
//                         <span className="text-[14px] font-black text-gray-900">₹{Math.round(Number(row.amount)).toLocaleString('en-IN')}</span>
//                       </td>
//                       <td>
...
//                             size="sm"
//                             variant="outline"
//                             className="h-8 px-3 text-purple-600 border-purple-200 hover:bg-purple-50 font-bold text-xs bg-white"
//                             onClick={() => {
...
//                             size="sm"
//                             variant="outline"
//                             className="h-8 px-3 text-red-600 border-red-200 hover:bg-red-50 font-bold text-xs bg-white"
